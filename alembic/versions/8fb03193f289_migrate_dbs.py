...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "FROZEN", "CLOSED", name="accountstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "transaction_type",
            sa.Enum("DEPOSIT", "WITHDRAWAL", "TRANSFER", "FEE", name="transactiontype"),
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["from_account_id"],
            ["accounts.id"],
            name=op.f("fk_transactions_from_account_id_accounts"),
        ),
        sa.ForeignKeyConstraint(
            ["to_account_id"],
            ["accounts.id"],
